...
def createCalendar(
    ...
    logging.info(datee)
    monthname = datetime.datetime.strptime(str(month), "%m")
    print(monthname.month, "mmmmm", monthname.strftime("%B"))
                    ...
                    try:
                        ...
                        if b > 1:
                            canvas.drawString(
                                x + 10,
                                y - 90,
                                str.split(str(b), ".")[0] + " MORE EVENTS",
                            )
                        if b == 1:
                            canvas.drawString(
                                x + 10,
                                y - 90,
                                str.split(str(b), ".")[0] + " MORE EVENT",
                            )
