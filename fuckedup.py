...
class TestCard(MDApp):
    ...
    def removeAll(self):
        # logging.info (dir(self.screen.ids.md_list))
    ...
    def make_list(self):
        ...
        for i in range(len(xxx) - 1):
            ...
            self.screen.ids.md_list.add_widget(SwipeToDeleteItem(text=texta))
    ...
    def on_start(self):
        ...
        self.make_list()
        logging.info(dir(self.root.ids.llogin), "shit")
