...
def createCalendar(a, month, year=NOW.year, canvas=None, filename=None, size=SIZE):
    """
        ...
        for day in week:
            ...
            if day:
                ...
                if event == True:
                    ...
                    canvas.drawString(x, y - 30, str(a[day]["venue"]))
                    canvas.drawString(x, y - 45, str(a[day]["show"]))
