...
def makeuserdata(App,config_file,ios):
    ...
    x = ' { "username":"test@gmail.com", "password":"", "city":"lasvegas","usecache":"True","pcolor":"Red","scolor":"White","debug":"True","theme":"Dark"}'
    y = json.loads(x)
...
def makeshowfile(App,x,config_file,ios):
    ...
    x = ' { "date":"'+x[0]+'", "time":"'+x[1]+'", "job":"'+x[2]+'","show":"'+x[3]+'","venue":"'+x[4]+'","location":"'+x[5]+'","client":"'+x[6]+'","type":"'+x[7]+'","pos":"'+x[8]+'","endtime":"'+newhours+'","lunches":"'+lunch+'"}'
    #print (x,'jsonfile')
    y = json.loads(x)
    try:
