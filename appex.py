#import 'pythonista'
#from _appex import is_running_extension, is_widget, get_input
#import _appex
import sys
#import ui
...
class _WidgetSimulatorView (ui.View):
    ...
    def use_in_today(self, sender):
        ...
        console.alert('Widget Script Set', 'The script "%s" is now used in the Pythonista Today widget. You can also change this in Pythonista\'s settings.\n\nThe Pythonista widget is available in the \"Today\" tab of Notification Center, and on the first page of the home/lock screen. You may need to add the widget first (by tapping the "Edit" button at the bottom).' % (relative_path,), 'OK', hide_cancel_button=True)
