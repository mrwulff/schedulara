def createcache(ad, numshows):
    ...
    for x in range(numshows):
        ...
        next = (
            ...
            + nexts
            + """</td><td class="cell-noborder" style="background-color:Gray;width:10px;">08:00</td><td class="cell-noborder" style="background-color:Gray;">24150</td><td class="cell-noborder" style="background-color:Gray;">"""
            + (random.choice(cshow))
            + """ </td><td class="cell-noborder" style="background-color:Gray;">"""
            + (random.choice(rven))
            + """</td><td class="cell-noborder" style="background-color:Gray;">PARK MGM LAS VEGAS</td><td class="cell-noborder" style="background-color:Gray;">MGM RESORTS</td><td class="cell-noborder" style="background-color:Gray;">IN</td><td class="cell-noborder" style="background-color:Gray;">"""
            + (random.choice(rpos))
    ...
    aaa.write(footers)
    aaa.close()
    logging.info("omg it saved a fucking file")
    return ad
